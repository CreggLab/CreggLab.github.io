...
{% for item in news_items %}{% assign item_year = item.date | date: "%Y" | plus: 0 %}{% if item_year < archive_before %}{% capture item_year_text %}{{ item_year }}{% endcapture %}{% if item_year_text != displayed_year %}
